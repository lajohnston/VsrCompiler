...
namespace VsrCompiler
{
    internal class LevelGroup
    {
        ...
        /// </summary>
        private CompiledLevel[] compiledUserLevels;
        ...
        /// </summary>
        private int fixedNumberOfLevels;
        ...
        {
            if (levelNumber > compiledUserLevels.Length - 1)
                return getNullLevel();
            else
                return compiledUserLevels[levelNumber];
        }
